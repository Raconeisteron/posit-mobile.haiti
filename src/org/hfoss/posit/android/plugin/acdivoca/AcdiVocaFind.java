...
public class AcdiVocaFind {
	...
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_FAO) boolean is_fao;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_SAVE) boolean is_save;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_CROSE) boolean is_crose;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_PLAN) boolean is_plan;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_MARDNR) boolean is_mardnr;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_OTHER_ORG) boolean is_other_org;
