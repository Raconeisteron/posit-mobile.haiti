...
public class AcdiVocaFind {
	...
	public static final String TEST_FIND = "id=0, address=null, category=null,"
			...
			+ "distributionMonthsRemaining=0, status=0, type=0," + "visitedByMotherLeader=false";

	// id is generated by the database and set on the object automagically
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_ID, generatedId = true)
	int id;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_DOSSIER)
	String dossier;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_TYPE)
	int type;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_STATUS)
	int status;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_MESSAGE_ID)
	int message_id;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_MESSAGE_STATUS)
	int message_status;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_FIRSTNAME)
	String firstname;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_LASTNAME)
	String lastname;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_ADDRESS)
	String address;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_DOB)
	String dob;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_SEX)
	String sex;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HOUSEHOLD_SIZE)
	String household_size;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_BENEFICIARY_CATEGORY)
	String beneficiary_category;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_DISTRIBUTION_POST)
	String distribution_post;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_COMMUNE_SECTION)
	String commune_section;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_Q_MOTHER_LEADER)
	boolean mother_leader;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_Q_VISIT_MOTHER_LEADER)
	boolean visit_mother_leader;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_Q_PARTICIPATING_AGRI)
	boolean participating_agri;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_Q_PARTICIPATING_BENE)
	boolean participating_bene;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_FARMER)
	boolean is_farmer;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_MUSO)
	boolean is_MUSO;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_RANCHER)
	boolean is_rancher;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_STOREOWN)
	boolean is_store_owner;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_FISHER)
	boolean is_fisher;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_ARTISAN)
	boolean is_artisan;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_OTHER)
	boolean is_other;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_LAND_AMOUNT)
	int amount_of_land;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_VEGE)
	boolean have_vege;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_TUBER)
	boolean have_tuber;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_CEREAL)
	boolean have_cereal;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_TREE)
	boolean have_tree;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_GRAFTING)
	boolean have_grafting;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_COFFEE)
	boolean have_coffee;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_FAO)
	boolean is_fao;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_SAVE)
	boolean is_save;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_CROSE)
	boolean is_crose;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_PLAN)
	boolean is_plan;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_MARDNR)
	boolean is_mardnr;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_IS_OTHER_ORG)
	boolean is_other_org;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_HOUE)
	boolean have_hoe;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_PIOCHE)
	boolean have_pick;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_BROUETTE)
	boolean have_wheelbarrow;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_MACHETTE)
	boolean have_machete;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_SERPETTE)
	boolean have_pruning_knife;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_PELLE)
	boolean have_shovel;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_HAVE_BARREAMINES)
	boolean have_crowbar;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_RELATIVE_1)
	String relative_1;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_RELATIVE_2)
	String relative_2;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_Q_CHANGE)
	...
	int MonthsRemaining;
	@DatabaseField(columnName = AcdiVocaDbHelper.FINDS_NAME_AGRI_PARTICIPANT)
	...
	/**
	 * Returns a representation of this Find in a highly compressed Sms (Text)
	 * message.
	 * 
	 * @return
	 */
	public AcdiVocaMessage toSmsMessage() {
		...
		String msgHeader = "MsgId:" + msg_id + ", Len:" + smsMessage.length() + ", " + statusStr + " Bid = "
				+ beneficiary_id;
	...
	/**
	 * Prepares the SMS for an update beneficiary (i.e., with DOSSIER number and
	 * distribution post).
	 * 
	 * @return
	 */
	private String toSmsUpdateMessage() {
		...
		sb.append(COMMA).append(AttributeManager.ABBREV_CATEGORY).append(EQ)
				.append(AttributeManager.mapToShort(beneficiary_category));
	...
	private String toSmsNewMchnMessage() {
		...
		sb.append(COMMA).append(AttributeManager.ABBREV_IS_MOTHERLEADER).append(EQ)
				.append(AttributeManager.mapToShort(mother_leader));
		sb.append(COMMA).append(AttributeManager.ABBREV_VISIT_MOTHERLEADER).append(EQ)
				.append(AttributeManager.mapToShort(visit_mother_leader));
		sb.append(COMMA).append(AttributeManager.ABBREV_RELATIVE_1).append(EQ).append(relative_1);
		sb.append(COMMA).append(AttributeManager.ABBREV_PARTICIPATING_BENE).append(EQ)
				.append(AttributeManager.mapToShort(participating_agri));
	...
	public String generateDistributionId() {
		...
		if (year.length() == 1)
			year = "0" + year;
		return distribution_post + "." + month + year;
	}
	 ...
	 * string. If the String already contains an SMS message in its
	 * 'message_text' field, then no need to construct it again.
	 * 
	 * @param beneficiary
	 *            a string of the form attr1-value1,attr2=value2...
	...
	private String abbreviateBeneficiaryStringForSms(String beneficiary) {
		...
		for (int k = 0; k < attr_val_pairs.length; k++) {
			...
			if (!attr.equals(AcdiVocaDbHelper.FINDS_ID) && !attr.equals(AcdiVocaDbHelper.FINDS_PROJECT_ID)
			// && !attr.equals(FINDS_MESSAGE_TEXT)
					&& !val.equals("null")) {
				if (attr.equals(AcdiVocaDbHelper.FINDS_DOB))
					abbrev = AttributeManager.convertAttrValPairToAbbrev(attr,
							AcdiVocaDbHelper.adjustDateForSmsReader(val));
				if (attr.equals(AcdiVocaDbHelper.FINDS_DISTRIBUTION_POST)) // new
																			// code
																			// to
																			// manage
																			// codes
																			...
																			// in
																			// DB
					abbrev = AttributeManager.getMapping(AcdiVocaDbHelper.FINDS_DISTRIBUTION_POST)
							+ AttributeManager.ATTR_VAL_SEPARATOR + val;
				else
	...
	/**
	 * Construct a raw message for this Find with full attribute names. For each
	 * attribute (field), concatenate an attr=val pair.
	 * 
	 * @return
	 */
	@Override
