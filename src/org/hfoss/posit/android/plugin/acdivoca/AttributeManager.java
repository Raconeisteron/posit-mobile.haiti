...
public class AttributeManager {
	...
	public static final String LIST_SEPARATOR = "&"; // Don't use '/' and don't
														// use '|'
	...
	public static final String FINDS_MESSAGE_TYPE = "message_type"; // Newly
																	// added
	...
	public static final String ABBREV_MONTHS = "mo"; // Added to compliment the
	...
	public static final String[] hasAFields = { ABBREV_HAVE_BARREMINES,
			ABBREV_HAVE_BROUTTE, ABBREV_HAVE_CEREAL, ABBREV_HAVE_HOE,
			ABBREV_HAVE_MACHETE, ABBREV_HAVE_PELLE, ABBREV_HAVE_PIOCHE,
			ABBREV_HAVE_SERPETTE, ABBREV_HAVE_TREE, ABBREV_HAVE_VEG,
	...
	// public static final String FINDS_MALNOURISHED_HA = "Enfant Mal"; //Note:
	// different spelling
	...
	public static final String FINDS_Q_CHANGE = "ChangeInStatus"; // Added to
																	// incorporated
																	// changes
																	// to
																	// beneficiary
	...
	// NEEDS TO TRANSLATE
	// public static final String FINDS_Q_TRANSFER_NEW_CATEGORY_HA =
	// "Transfere nan yon lòt kategori";
	// public static final String FINDS_Q_TRANSFER_LACTATE_HA =
	// "Transfert de: Enceinte à Allaitante";
	// public static final String FINDS_Q_TRANSFER_PREVENTION_HA =
	// "Transfert de: Allaitante à Prevention";
	// public static final String FINDS_Q_TRANSFER_LOCATION_HA =
	// "Transfert du au changement de lieu";
	// public static final String FINDS_Q_TRANSFER_ABORTION_HA =
	// "Transfert du a cause de l’avortement";
	// public static final String FINDS_Q_DECEASED_HA = "Decede";
	// public static final String FINDS_Q_FRAUD_HA = "Fraud";
	// public static final String FINDS_Q_COMPLETED_PROGRAM_HA =
	// "Cycle complet";
	...
	public static final String LONG_COMMUNE_SECTION = "commune_section";
	...
	// public static final String LONG_GENERAL_INFORMATION =
	// "generalInformation";
	...
	// public static final String PT_FIXE_BAIE_D_ORANGE =
	// "Pt fixe Baie d_orange";
	// public static final String DISPENSAIRE_MARBRIOLE =
	// "Dispensaire marbriole";
	// public static final String PT_FIXE_CORAIL_LAMOTHE =
	// "Pt fixe Corail Lamothe";
	...
	// public static final String DISPENSAIRE_STE_ROSE_DE_LIMA =
	// "Dispensaire Ste rose de lima";
	// public static final String DISPENSAIRE_BOUCAN_BELIER =
	// "Dispensaire Boucan Belier";
	// public static final String DISPENSAIRE_RICOT = "Dispensaire Ricot";
	// public static final String PT_FIXE_MACIEUX = "Pt Fixe Macieux";
	// public static final String POINT_FIXE_DE_MAYETTE =
	// "Point Fixe de Mayette";
	// public static final String POINT_FIXE_DE_AMAZONE =
	// "Point Fixe de Amazone";
	// public static final String DISPENSAIRE_GRAND_GOSIER =
	// "Dispensaire Grand Gosier";
	...
	// public static final String DISPENSAIRE_DE_SAVANE_ZOMBI =
	// "Dispensaire de Savane Zombi";
	// public static final String DISPENSAIRE_DE_BLACK_MAR_MIRANDE =
	// "Dispensaire de Bleck/ Mar Mirande";
	//
	...
	public static void init() {
		...
		// mappings.put(FINDS_Q_TRANSFER_PREVENTION_HA,
		// ABBREV_Q_TRANSFER_PREVENTION);
		// mappings.put(FINDS_Q_TRANSFER_LOCATION_HA,
		// ABBREV_Q_TRANSFER_LOCATION);
		// mappings.put(FINDS_Q_TRANSFER_ABORTION_HA,
		// ABBREV_Q_TRANSFER_ABORTION);
		// mappings.put(FINDS_Q_DECEASED_HA, ABBREV_Q_DECEASED);
		// mappings.put(FINDS_Q_FRAUD_HA, ABBREV_Q_FRAUD);
		// mappings.put(FINDS_Q_COMPLETED_PROGRAM_HA,
		// ABBREV_Q_COMPLETED_PROGRAM);
	 ...
	 * 
	 * 
	 * Centre Platon Cedre HEAP-014 Point Fixe Ka Tousen HEAP-017 Anse a Pitres
	 * HEAP-020 dispensaire Banane HEAP-021
	 * 
	 * Pt fixe Calumette HEBA-016 Centre Belle-Ance HEBA-017 Dispensaire Mapou
	 * HEBA006 Pt fixe Baie d_orange HEBA007 Dispensaire marbriole HEBA008 Pt
	 * fixe Corail Lamothe HEBA009 Pt fixe Pichon HEBA010 Pt Fixe Bel-air
	 * HEBA015
	 * 
	 * Labiche HECF-005 Centre St Joseph HECF001 Dispensaire Ste rose de lima
	 * HECF002 Dispensaire Boucan Belier HECF003 Dispensaire Ricot HECF004 Pt
	 * Fixe Macieux HECF023 Point Fixe de Mayette HECF024 Point Fixe de Amazone
	 * HECF025
	 * 
	 * Dispensaire Grand Gosier HEGG-018 Dispensaire Bodarie HEGG-019 Pt fixe
	 * Boulay HEGG-020
	 * 
	 * Centre Sacre Coeur HETH-024 Dispensaire de Savane Zombi HETH026
	...
	private static boolean isUnmappedValue(String attr) {
		if (attr.equals(FINDS_FIRSTNAME) || attr.equals(FINDS_LASTNAME)
